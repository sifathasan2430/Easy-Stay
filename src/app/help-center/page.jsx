...
const HelpCenter = () => {
  return (
    <main className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Booking Issues</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Account Support</h2>
      <p className="mb-4">
        For account-related issues such as login problems, password reset, or account verification, reach out to our support team.
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">Property Support</h2>
      <p className="mb-4">
        Hosts and guests can contact support for property-related concerns, cancellations, or refunds.
      </p>

      <p className="mt-6">Still have questions? <a href="mailto:support@easystay.com" className="text-blue-600 hover:underline">Contact Support</a></p>
    </main>
  );
};
